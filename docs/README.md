...
- **[数据拉取流程](download_flow.md)** - 全量/增量下载详细流程图
- **[服务器连通性监控](monitor_design.md)** - 服务器监控方案设计
- **[调度方案详细设计](调度方案详细设计.md)** - 任务调度器架构与配置设计
- **[改进计划](improvement_plan.md)** - 已知问题、改进建议和实施路线图
- **[优化方案](optimization_plan.md)** - K 线优先、财务降级优化计划
- **[IPO 日期优化](ipo_based_download_optimization.md)** - 基于 IPO 日期的下载优化
- **[数据分析](数据分析.md)** - 各表 API 拉取前置条件分析
...
### 4. 代码质量
- **[代码审查报告](code_review_2026-04-28.md)** - 全代码逻辑审查（27个文件，11项问题）
...
- **2026-06-18**：新增服务器连通性监控机制，邮件日报展示监控事件
- **2026-05-23**：修复全量下载脚本周线/月线无条件下载 bug
- **2026-05-22**：更新增量更新策略说明（周线/月线按需下载）
- **2026-05-16**：V2.1.0，新增调度方案详细设计文档，维护全部文档一致性
- **2026-05-07**：发布 v2.0，修复多项 bug 并重构关键模块
